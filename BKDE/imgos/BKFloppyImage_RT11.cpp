...
const std::wstring CBKFloppyImage_RT11::GetSpecificData(BKDirDataItem *fr) const
{
	...
	// чтобы не усложнять метод вывода, просто добавим в массив несуществующие месяцы,
	// при ошибке всё будет хорошо видно
	static const wchar_t *strMons[16] =
	{
		L"Нул",
		L"Янв", L"Фев", L"Мар", L"Апр",
		L"Май", L"Июн", L"Июл", L"Авг",
	...
	if (nDay && nMon)
	{
		...
		strDate = imgUtil::string_format(L"%02d-%s-%4d\0", nDay, strMons[nMon], nYear);
	}
