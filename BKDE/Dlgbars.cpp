...
BEGIN_MESSAGE_MAP(CDlgToolBar, CTrueColorToolBar)
	// {{AFX_MSG_MAP(CDlgToolBar)
	ON_MESSAGE(WM_IDLEUPDATECMDUI, &CDlgToolBar::OnIdleUpdateCmdUI)
...
LRESULT CDlgToolBar::OnIdleUpdateCmdUI(WPARAM wParam, LPARAM)
{
	if (IsWindowVisible())
	{
		auto pParent = reinterpret_cast<CFrameWnd *>(GetParent());
