...
#define VERSION_NUM 2401
#define REVISION_NUM 10604
...
#define FILE_COPYRIGHT_STR L"Copyright (с) 2003 Ю.Калмыков, Копировать правильно (c) 2012-2023 gid. Используйте на своё усмотрение."
...
#define DESTRUCT_VAL 0x16

// Версия для сборки скалолазовых доёбов (частично работает кое-где)
//#define SCALOLAZ_VERSION 0
