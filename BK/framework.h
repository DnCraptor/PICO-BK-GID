...
// без этого можно обойтись, оно само уже где-то определяется.
//#include <afxtoolbarimages.h>
// это нужно чтобы png файлы в ресурсах хранить и их можно было оттуда загружать, но и без этого можно обойтись
